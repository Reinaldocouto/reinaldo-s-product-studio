...
export const highlights = [
  {
    ...
    description: "Experiência prática com ERP, fluxos operacionais e arquitetura modular.",
  },
  {
    title: "Visão de produto",
    description: "Decisões orientadas a contexto, jornada do usuário e regra de negócio.",
  },
  {
    title: "Front moderno + integrações",
    description: "React, TypeScript, APIs, mapas, autenticação e dashboards.",
  },
  {
    title: "Ponte entre negócio e tech",
    description: "Bagagem em ambiente crítico, decisão sob pressão e leitura de processo.",
  },
];
...
export const stack = [
  ...
  },
  {
    ...
    items: ["Modelagem de domínio", "Documentação", "UX orientada", "Git / GitHub"],
  },
];
